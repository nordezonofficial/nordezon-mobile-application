...
import { Dimensions, FlatList, Image, Keyboard, KeyboardAvoidingView, Modal, Platform, StyleSheet, Text, TextInput, TouchableOpacity, View } from 'react-native';
...
export default function CommentsBottomSheet({ visible, onClose, onAddComment, onAddReply, post }: CommentsBottomSheetProps) {
        ...
        >
            ...
            >
                <SafeAreaView style={styles.backdrop}>
                    <View style={[styles.bottomSheet, { top: keyboardVisible ? 0 : responsiveTop }]}>
    ...
    //                 top: keyboardVisible ? 0 : responsiveTop, // smoothly responsive
    //             },]}>
    //                 {/* Handle Bar */}
    //                 <TouchableOpacity onPress={() => onClose()}>
    //                     <View style={styles.handleContainer}>
    ...
    //                                 <View style={styles.commentItem}>
    //                                     <View style={styles.commentAvatar}>
    //                                         {comment?.user?.role === "BRAND"
    //                                             ? comment.user.logoUrl
    //                                                 ? (
    //                                                     <Image
    //                                                         source={{ uri: comment.user.logoUrl }}
    //                                                         style={styles.logo}
    //                                                     />
    //                                                 )
    //                                                 : (
    ...
    //                                                 ? (
    //                                                     <Image
    //                                                         source={{ uri: comment.user.profile }}
    //                                                         style={styles.logo}
    //                                                     />
    //                                                 )
    //                                                 : (
    ...
    //                                     <View style={styles.commentContent}>
    //                                         <CText style={styles.commentUser}>{comment.user.fullName}</CText>
    //                                         <Description
    //                                             style={{
    //                                                 marginTop: -5,
    //                                                 marginBottom: 5,
    ...
    //                                             <TouchableOpacity
    //                                                 onPress={() => handleReply(comment.id, comment.user.id)}
    //                                                 style={styles.replyActionButton}
    //                                             >
    ...
    //                             styles.sendButton,
    //                             {
    //                                 backgroundColor: (replyingTo ? replyText.trim() : commentText.trim()) ? primaryOrange : primaryOrange
    //                             }
    //                         ]}
    //                     >
    //                         <Ionicons
    //                             name="send"
    //                             size={24}
    //                             color={(replyingTo ? replyText.trim() : commentText.trim()) ? '#fff' : "#fff"}
    //                         />
    //                     </CTouchableOpacity>
    //                 </View>
    //             </View>
